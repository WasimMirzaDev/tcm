...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::get('/event-category/destroy/{id}', [EventCategoryController::class, 'destroy'])->name('event-category.destroy');

    // Event
    Route::resource('event', EventController::class);
    Route::controller(EventController::class)->group(function () {
        Route::get('/bookedevent', 'bookedevent')->name('bookedevent');
        Route::get('/event/destroy/{id}', 'destroy')->name('event.destroy');
        Route::post('/event/change-status', 'change_status')->name('event.change-status');
    });
