...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/single-event', 'single-event')->name('single-event');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/view-cart', 'view_cart')->name('cart.view_cart');
...
Route::controller(EventController::class)->group(function () {
    Route::get('/events', 'all_event')->name('event');
    Route::get('/event/{slug}', 'event_details')->name('event.details');
    Route::get('/bookevent/{id}', 'event_booking')->name('event.event_booking');
