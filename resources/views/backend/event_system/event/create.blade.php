        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="add_form" class="form-horizontal" action="{{ route('event.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Price')}}
                            <span class="text-danger">*</span></label>
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Price')}}" name="price" id="price" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Date')}}
                            <span class="text-danger">*</span></label>
                        <div class="col-md-9">
                            <input type="date" placeholder="{{translate('Date')}}" name="event_date" id="event_date" class="form-control" required>
                        </div>
                    </div>
