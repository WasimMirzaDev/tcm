...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('events/css/style.css') }}">
    <link rel="stylesheet" href="{{ static_asset('events/css/vendor.css') }}">
    <link rel="stylesheet" href="{{ static_asset('events/css/app-responsive.css') }}"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.6.5/sweetalert2.min.css" integrity="sha512-NvuRGlPf6cHpxQqBGnPe7fPoACpyrjhlSNeXVUY7BZAj1nNhuNpRBq3osC4yr2vswUEuHq2HtCsY2vfLNCndYA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
      <style>
        :root {
...
<body">
    <div class="body-wrapper">
                    ...
                    <div class="col-lg-3 d-lg-block d-none">
                        <div class="announcement-meta-wrapper d-flex align-items-center justify-content-end">
                            <div class="announcement-meta d-flex align-items-center">
                                ...
                                <a class="announcement-login announcement-text text-white" href="{{route('dashboard')}}">
                                    <svg class="icon icon-user" width="10" height="11" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5 0C3.07227 0 1.5 1.57227 1.5 3.5C1.5 4.70508 2.11523 5.77539 3.04688 6.40625C1.26367 7.17188 0 8.94141 0 11H1C1 8.78516 2.78516 7 5 7C7.21484 7 9 8.78516 9 11H10C10 8.94141 8.73633 7.17188 6.95312 6.40625C7.88477 5.77539 8.5 4.70508 8.5 3.5C8.5 1.57227 6.92773 0 5 0ZM5 1C6.38672 1 7.5 2.11328 7.5 3.5C7.5 4.88672 6.38672 6 5 6C3.61328 6 2.5 4.88672 2.5 3.5C2.5 2.11328 3.61328 1 5 1Z"
        ...
        <header class="sticky-header border-btm-black header-1">
            <div class="header-bottom">
                <div class="container">
                    <div class="row align-items-center main_header_wrapper">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" style="width: 120px;" loading="lazy" alt="bisum">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" loading="lazy" alt="bisum">
                        @endif
                                </a>
                            </div>
                        </div>
                                ...
                                <ul class="main-menu list-unstyled justify-content-center">
                                      ...
                                      @foreach (json_decode( get_setting('header_menu_labels'), true) as $key => $value)
                                       ...
                                       <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="https://wideapps.agency/tcmgame/search">
                                                Shop
                                            </a>
                                    </li>
                                        ...
                                        <div class="submenu-transform submenu-transform-desktop">
                                            <ul class="submenu list-unstyled">
                                                <li class="menu-list-item nav-item-sub">
                                                    <a class="nav-link-sub nav-text-sub" href="https://wideapps.agency/tcmgame/category/game--categories-tme6k">Hats for boy</a>
                                                </li>
                                                <li class="menu-list-item nav-item-sub">
                                                    <a class="nav-link-sub nav-text-sub" href="https://wideapps.agency/tcmgame/category/ripkan-hxw11">Game Hat</a>
                                                </li>
                                                <li class="menu-list-item nav-item-sub">
                                                    <a class="nav-link-sub nav-text-sub" href="https://wideapps.agency/tcmgame/category/new-game-discord-zpgkd">black Game</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                        @else
                                        <li class="menu-list-item nav-item">
                                        <a class="nav-link" href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}">{{ translate($value) }}</a>
                                        </li>
                                        @endif
                        ...
                        <div class="col-lg-3 col-md-8 col-4">
                            <div class="header-action d-flex align-items-center justify-content-end">
                                ...
                                <a class="header-action-item header-cart ms-4" href="{{url('view-cart')}}"
                                    >
                                    ...
                                    <span class="badge badge-primary badge-inline badge-pill cart-count cart-number" style="background: #981cff">
                                        {{ count($cart) }}
                                    </span>
                                    @else
                                     <span class="badge badge-primary badge-inline badge-pill cart-count cart-number" style="background: #981cff">
                ...
                <div class="search-wrapper">
                    <div class="container">
                        <form class="form-search form-search-width-category stop-propagation search-form d-flex align-items-center" action="{{ route('search') }}" method="GET" >
            ...
            <div class="footer-top bg-5">
                <div class="container">
                    <div class="footer-widget-wrapper">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" style="margin-top: -46px;" loading="lazy" alt="bisum">
                        @else
                            <img src="{{ static_asset('assets/img/logo.png') }}" loading="lazy" alt="bisum">
                        @endif</a>
                                    </h4>
            ...
            <div class="offcanvas-wrapper">
                ...
                <div class="offcanvas-body p-0 d-flex flex-column justify-content-between">
                    ...
                    <ul class="utility-menu list-unstyled">
                        ...
                        <li class="utilty-menu-item">
                            <a class="announcement-login announcement-text" href="{{route('register')}}">
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-user" width="24" height="24" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        @auth
                        <li class="utilty-menu-item">
                            <a class="announcement-login announcement-text" href="{{route('logout')}}">
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-user" width="24" height="24" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li class="utilty-menu-item">
                            <a class="announcement-login announcement-text" href="{{route('dashboard')}}">
                                <span class="utilty-icon-wrapper">
                                    <svg class="icon icon-user" width="24" height="24" viewBox="0 0 10 11" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <li class="utilty-menu-item">
                            <button type="button" class="currency-btn btn-reset" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <img class="flag" src="{{ static_asset('assets/img/flag/usd.jpg') }}" alt="img">
                                <span>USD</span>
                                <span class="utilty-icon-wrapper">
                            ...
                            <ul class="currency-list dropdown-menu dropdown-menu-end px-2">
                                ...
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="CAD">
                                        <img class="flag" src="{{ static_asset('assets/img/flag/cad.jpg') }}" alt="img">
                                        <span>CAD</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="EUR">
                                        <img class="flag" src="{{ static_asset('assets/img/flag/eur.jpg') }}" alt="img">
                                        <span>EUR</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="JPY">
                                        <img class="flag" src="{{ static_asset('assets/img/flag/jpy.jpg') }}" alt="img">
                                        <span>JPY</span>
                                    </a>
                                </li>
                                <li class="currency-list-item ">
                                    <a class="currency-list-option" href="#" data-value="GBP">
                                        <img class="flag" src="{{ static_asset('assets/img/flag/gbp.jpg') }}" alt="img">
                                        <span>GBP</span>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="cart-content-area d-flex justify-content-between flex-column">
                    ...
                    <div class="minicart-footer">
                        ...
                        <div class="minicart-btn-area d-flex align-items-center justify-content-between">
                            <a href="/tcmgame/view-cart" class="minicart-btn btn-secondary">View Cart</a>
    ...
    <script src="{{ static_asset('events/js/vendor.js') }}"></script>
    <script src="{{ static_asset('events/js/main.js') }}"></script>
    <script src="{{ static_asset('events/js/jquery.steps.js') }}"></script>
    <script src="{{ static_asset('events/js/jquery.steps.min.js') }}"></script>
    ...
    <script>
      function showCheckoutModal() {
       ...
       $(document).ready(function(){
            ...
            $('.aiz-plus-minuz input').off('change').on('change', function () {
                ...
                $.ajax({
                    ...
                    const Toast = Swal.mixin({
                      ...
                      didOpen: (toast) => {
                       ...
                       <!--$('#addToCart-modal-body').html(datas.modal_view);-->
